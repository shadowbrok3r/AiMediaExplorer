...
impl crate::app::SmartMediaApp {
    pub fn receive(&mut self, ctx: &eframe::egui::Context) {
        ...
        if self.open_settings_modal {
            ...
            eframe::egui::Modal::new(Id::new("Preferences"))
            .show(ctx, |ui| {
                ...
                ui.separator();
                {
                    ...
                    ui.collapsing("Filters", |ui| {
                        ...
                        ui.horizontal(|ui| { ui.label("Modified After (YYYY-MM-DD)"); ui.text_edit_singleline(d.filter_modified_after.get_or_insert(String::new())); });
                        ui.horizontal(|ui| { ui.label("Modified Before"); ui.text_edit_singleline(d.filter_modified_before.get_or_insert(String::new())); });
                    });
                }
                ui.separator();
                ui.horizontal(|ui| {
                    ...
                    if ui.button("Close").clicked() { self.open_settings_modal = false; }
                });
            });
